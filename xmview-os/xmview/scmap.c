...
struct sc_map scmap[]={
...
#ifdef _UM_MMAP
	/* MMAP management */
	{__NR_mmap,	choice_mmap,	wrap_in_mmap, wrap_out_mmap,	always_umnone,	NULL, 0,	6, SOC_MMAP},
	{__NR_mmap2,	choice_mmap,	wrap_in_mmap, wrap_out_mmap,	always_umnone,	NULL, 0,	6, SOC_MMAP},
	{__NR_munmap,	always_umnone,	wrap_in_munmap, wrap_out_munmap,always_umnone,	NULL, ALWAYS,	2, SOC_MMAP},
	...
	{__NR_settimeofday, choice_sc,	wrap_in_settimeofday, wrap_out_std,	always_umnone,	NULL, 0,	2, SOC_TIME},
	{__NR_adjtimex, choice_sc,	wrap_in_adjtimex, wrap_out_std,	always_umnone,	NULL, 0,	1, SOC_TIME},
	{__NR_clock_gettime, choice_sc,	wrap_in_clock_gettime, wrap_out_std,	always_umnone,	NULL, 0,	2, SOC_TIME},
	...
	/* user mgmt calls */
	{__NR_getuid,	choice_sc,	wrap_in_getxid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setuid,	choice_sc,	wrap_in_setuid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_geteuid,	choice_sc,	wrap_in_getxid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setfsuid,	choice_sc,	wrap_in_setuid, wrap_out_std, 	always_umnone,	NULL, 0,	1, SOC_UID},
	{__NR_setreuid,	choice_sc,	wrap_in_setreuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	2, SOC_UID},
	{__NR_getresuid, choice_sc,	wrap_in_getresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_setresuid, choice_sc,	wrap_in_setresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_getgid,	choice_sc,	wrap_in_getxid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setgid,	choice_sc,	wrap_in_setgid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_getegid,	choice_sc,	wrap_in_getxid16, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setfsgid,	choice_sc,	wrap_in_setgid16, wrap_out_std, 	always_umnone,	NULL, 0,	1, SOC_UID},
	{__NR_setregid,	choice_sc,	wrap_in_setregid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	2, SOC_UID},
	{__NR_getresgid, choice_sc,	wrap_in_setresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_setresgid, choice_sc,	wrap_in_setresgid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_getuid32,	choice_sc,	wrap_in_getxid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setuid32,	choice_sc,	wrap_in_setuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_geteuid32,	choice_sc,	wrap_in_getxid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setfsuid32,	choice_sc,	wrap_in_setuid, wrap_out_std, 	always_umnone,	NULL, 0,	1, SOC_UID},
	{__NR_setreuid32,	choice_sc,	wrap_in_setreuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	2, SOC_UID},
	{__NR_getresuid32, choice_sc,	wrap_in_getresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_setresuid32, choice_sc,	wrap_in_setresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_getgid32,	choice_sc,	wrap_in_getxid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setgid32,	choice_sc,	wrap_in_setgid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_getegid32,	choice_sc,	wrap_in_getxid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	1, SOC_UID},
	{__NR_setfsgid32,	choice_sc,	wrap_in_setgid, wrap_out_std, 	always_umnone,	NULL, 0,	1, SOC_UID},
	{__NR_setregid32,	choice_sc,	wrap_in_setregid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	2, SOC_UID},
	{__NR_getresgid32, choice_sc,	wrap_in_setresuid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	{__NR_setresgid32, choice_sc,	wrap_in_setresgid, wrap_out_std, 	always_umnone,	NULL, ALWAYS,	3, SOC_UID},
	  
	/* priority related calls */
	{__NR_nice,	choice_sc,	wrap_in_nice,  wrap_out_std,	always_umnone,	NULL, 0,	1, SOC_PRIO},
	{__NR_getpriority, choice_sc,	wrap_in_getpriority, wrap_out_std, always_umnone,	NULL, 0,	2, SOC_PRIO},
	{__NR_setpriority, choice_sc,	wrap_in_setpriority, wrap_out_std, always_umnone,	NULL, 0,	3, SOC_PRIO},
