...
struct dhcp
{
  ...
  struct ip4_addr server_ip_addr; /* dhcp server address that offered this lease */
  struct ip4_addr offered_ip_addr;
  struct ip4_addr offered_sn_mask;
  struct ip4_addr offered_gw_addr;
  struct ip4_addr offered_bc_addr;
#define DHCP_MAX_DNS 2
  u32_t dns_count; /* actual number of DNS servers obtained */
  struct ip4_addr offered_dns_addr[DHCP_MAX_DNS]; /* DNS server addresses */
...
struct dhcp_msg
{
  ...
  PACK_STRUCT_FIELD(struct ip4_addr ciaddr);
  PACK_STRUCT_FIELD(struct ip4_addr yiaddr);
  PACK_STRUCT_FIELD(struct ip4_addr siaddr);
  PACK_STRUCT_FIELD(struct ip4_addr giaddr);
